...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.PermittedInt(form.Genre, 1, 2, 3, 4), "genre", "This field must equal some value")
	if !form.Valid() {
		data := app.newTemplateData(r)
		data.Form = form
	...
	id, err := app.snippets.Insert(form.Title, form.Content, form.Expires, form.Genre)
	if err != nil {
		app.serverError(w, err)
		return
	}
